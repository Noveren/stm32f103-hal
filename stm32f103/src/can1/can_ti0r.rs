...
pub type R = crate::R<CAN_TI0R_SPEC>;
#[doc = "Register `CAN_TI0R` writer"]
pub type W = crate::W<CAN_TI0R_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txrq(&mut self) -> TXRQ_W<CAN_TI0R_SPEC> {
        TXRQ_W::new(self, 0)
    }
    #[doc = "Bit 1 - RTR"]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RTR_W<CAN_TI0R_SPEC> {
        RTR_W::new(self, 1)
    }
    #[doc = "Bit 2 - IDE"]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IDE_W<CAN_TI0R_SPEC> {
        IDE_W::new(self, 2)
    }
    #[doc = "Bits 3:20 - EXID"]
    #[inline(always)]
    #[must_use]
    pub fn exid(&mut self) -> EXID_W<CAN_TI0R_SPEC> {
        EXID_W::new(self, 3)
    }
    #[doc = "Bits 21:31 - STID"]
    #[inline(always)]
    #[must_use]
    pub fn stid(&mut self) -> STID_W<CAN_TI0R_SPEC> {
        STID_W::new(self, 21)
    }
...
#[doc = "CAN_TI0R\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`can_ti0r::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`can_ti0r::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CAN_TI0R_SPEC;
impl crate::RegisterSpec for CAN_TI0R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_ti0r::R`](R) reader structure"]
impl crate::Readable for CAN_TI0R_SPEC {}
#[doc = "`write(|w| ..)` method takes [`can_ti0r::W`](W) writer structure"]
impl crate::Writable for CAN_TI0R_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CAN_TI0R to value 0"]
impl crate::Resettable for CAN_TI0R_SPEC {

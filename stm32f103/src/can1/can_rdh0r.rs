...
pub type R = crate::R<CAN_RDH0R_SPEC>;
...
#[doc = "CAN_RDH0R\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`can_rdh0r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CAN_RDH0R_SPEC;
impl crate::RegisterSpec for CAN_RDH0R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_rdh0r::R`](R) reader structure"]
impl crate::Readable for CAN_RDH0R_SPEC {}
#[doc = "`reset()` method sets CAN_RDH0R to value 0"]
impl crate::Resettable for CAN_RDH0R_SPEC {

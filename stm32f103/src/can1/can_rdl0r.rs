...
pub type R = crate::R<CAN_RDL0R_SPEC>;
...
#[doc = "CAN_RDL0R\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`can_rdl0r::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CAN_RDL0R_SPEC;
impl crate::RegisterSpec for CAN_RDL0R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_rdl0r::R`](R) reader structure"]
impl crate::Readable for CAN_RDL0R_SPEC {}
#[doc = "`reset()` method sets CAN_RDL0R to value 0"]
impl crate::Resettable for CAN_RDL0R_SPEC {

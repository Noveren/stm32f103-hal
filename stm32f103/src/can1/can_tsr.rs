...
pub type R = crate::R<CAN_TSR_SPEC>;
#[doc = "Register `CAN_TSR` writer"]
pub type W = crate::W<CAN_TSR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rqcp0(&mut self) -> RQCP0_W<CAN_TSR_SPEC> {
        RQCP0_W::new(self, 0)
    }
    #[doc = "Bit 1 - TXOK0"]
    #[inline(always)]
    #[must_use]
    pub fn txok0(&mut self) -> TXOK0_W<CAN_TSR_SPEC> {
        TXOK0_W::new(self, 1)
    }
    #[doc = "Bit 2 - ALST0"]
    #[inline(always)]
    #[must_use]
    pub fn alst0(&mut self) -> ALST0_W<CAN_TSR_SPEC> {
        ALST0_W::new(self, 2)
    }
    #[doc = "Bit 3 - TERR0"]
    #[inline(always)]
    #[must_use]
    pub fn terr0(&mut self) -> TERR0_W<CAN_TSR_SPEC> {
        TERR0_W::new(self, 3)
    }
    #[doc = "Bit 7 - ABRQ0"]
    #[inline(always)]
    #[must_use]
    pub fn abrq0(&mut self) -> ABRQ0_W<CAN_TSR_SPEC> {
        ABRQ0_W::new(self, 7)
    }
    #[doc = "Bit 8 - RQCP1"]
    #[inline(always)]
    #[must_use]
    pub fn rqcp1(&mut self) -> RQCP1_W<CAN_TSR_SPEC> {
        RQCP1_W::new(self, 8)
    }
    #[doc = "Bit 9 - TXOK1"]
    #[inline(always)]
    #[must_use]
    pub fn txok1(&mut self) -> TXOK1_W<CAN_TSR_SPEC> {
        TXOK1_W::new(self, 9)
    }
    #[doc = "Bit 10 - ALST1"]
    #[inline(always)]
    #[must_use]
    pub fn alst1(&mut self) -> ALST1_W<CAN_TSR_SPEC> {
        ALST1_W::new(self, 10)
    }
    #[doc = "Bit 11 - TERR1"]
    #[inline(always)]
    #[must_use]
    pub fn terr1(&mut self) -> TERR1_W<CAN_TSR_SPEC> {
        TERR1_W::new(self, 11)
    }
    #[doc = "Bit 15 - ABRQ1"]
    #[inline(always)]
    #[must_use]
    pub fn abrq1(&mut self) -> ABRQ1_W<CAN_TSR_SPEC> {
        ABRQ1_W::new(self, 15)
    }
    #[doc = "Bit 16 - RQCP2"]
    #[inline(always)]
    #[must_use]
    pub fn rqcp2(&mut self) -> RQCP2_W<CAN_TSR_SPEC> {
        RQCP2_W::new(self, 16)
    }
    #[doc = "Bit 17 - TXOK2"]
    #[inline(always)]
    #[must_use]
    pub fn txok2(&mut self) -> TXOK2_W<CAN_TSR_SPEC> {
        TXOK2_W::new(self, 17)
    }
    #[doc = "Bit 18 - ALST2"]
    #[inline(always)]
    #[must_use]
    pub fn alst2(&mut self) -> ALST2_W<CAN_TSR_SPEC> {
        ALST2_W::new(self, 18)
    }
    #[doc = "Bit 19 - TERR2"]
    #[inline(always)]
    #[must_use]
    pub fn terr2(&mut self) -> TERR2_W<CAN_TSR_SPEC> {
        TERR2_W::new(self, 19)
    }
    #[doc = "Bit 23 - ABRQ2"]
    #[inline(always)]
    #[must_use]
    pub fn abrq2(&mut self) -> ABRQ2_W<CAN_TSR_SPEC> {
        ABRQ2_W::new(self, 23)
    }
...
#[doc = "CAN_TSR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`can_tsr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`can_tsr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CAN_TSR_SPEC;
impl crate::RegisterSpec for CAN_TSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_tsr::R`](R) reader structure"]
impl crate::Readable for CAN_TSR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`can_tsr::W`](W) writer structure"]
impl crate::Writable for CAN_TSR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CAN_TSR to value 0"]
impl crate::Resettable for CAN_TSR_SPEC {

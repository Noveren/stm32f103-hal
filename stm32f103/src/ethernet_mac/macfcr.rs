...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fcb_bpa(&mut self) -> FCB_BPA_W<MACFCR_SPEC> {
        FCB_BPA_W::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit flow control enable"]
    #[inline(always)]
    #[must_use]
    pub fn tfce(&mut self) -> TFCE_W<MACFCR_SPEC> {
        TFCE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Receive flow control enable"]
    #[inline(always)]
    #[must_use]
    pub fn rfce(&mut self) -> RFCE_W<MACFCR_SPEC> {
        RFCE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Unicast pause frame detect"]
    #[inline(always)]
    #[must_use]
    pub fn upfd(&mut self) -> UPFD_W<MACFCR_SPEC> {
        UPFD_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Pause low threshold"]
    #[inline(always)]
    #[must_use]
    pub fn plt(&mut self) -> PLT_W<MACFCR_SPEC> {
        PLT_W::new(self, 4)
    }
    #[doc = "Bit 7 - Zero-quanta pause disable"]
    #[inline(always)]
    #[must_use]
    pub fn zqpd(&mut self) -> ZQPD_W<MACFCR_SPEC> {
        ZQPD_W::new(self, 7)
    }
    #[doc = "Bits 16:31 - Pass control frames"]
    #[inline(always)]
    #[must_use]
    pub fn pt(&mut self) -> PT_W<MACFCR_SPEC> {
        PT_W::new(self, 16)
    }

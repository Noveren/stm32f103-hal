...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pm(&mut self) -> PM_W<MACFFR_SPEC> {
        PM_W::new(self, 0)
    }
    #[doc = "Bit 1 - Hash unicast"]
    #[inline(always)]
    #[must_use]
    pub fn hu(&mut self) -> HU_W<MACFFR_SPEC> {
        HU_W::new(self, 1)
    }
    #[doc = "Bit 2 - Hash multicast"]
    #[inline(always)]
    #[must_use]
    pub fn hm(&mut self) -> HM_W<MACFFR_SPEC> {
        HM_W::new(self, 2)
    }
    #[doc = "Bit 3 - Destination address inverse filtering"]
    #[inline(always)]
    #[must_use]
    pub fn daif(&mut self) -> DAIF_W<MACFFR_SPEC> {
        DAIF_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pass all multicast"]
    #[inline(always)]
    #[must_use]
    pub fn pam(&mut self) -> PAM_W<MACFFR_SPEC> {
        PAM_W::new(self, 4)
    }
    #[doc = "Bit 5 - Broadcast frames disable"]
    #[inline(always)]
    #[must_use]
    pub fn bfd(&mut self) -> BFD_W<MACFFR_SPEC> {
        BFD_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - Pass control frames"]
    #[inline(always)]
    #[must_use]
    pub fn pcf(&mut self) -> PCF_W<MACFFR_SPEC> {
        PCF_W::new(self, 6)
    }
    #[doc = "Bit 8 - Source address inverse filtering"]
    #[inline(always)]
    #[must_use]
    pub fn saif(&mut self) -> SAIF_W<MACFFR_SPEC> {
        SAIF_W::new(self, 8)
    }
    #[doc = "Bit 9 - Source address filter"]
    #[inline(always)]
    #[must_use]
    pub fn saf(&mut self) -> SAF_W<MACFFR_SPEC> {
        SAF_W::new(self, 9)
    }
    #[doc = "Bit 10 - Hash or perfect filter"]
    #[inline(always)]
    #[must_use]
    pub fn hpf(&mut self) -> HPF_W<MACFFR_SPEC> {
        HPF_W::new(self, 10)
    }
    #[doc = "Bit 31 - Receive all"]
    #[inline(always)]
    #[must_use]
    pub fn ra(&mut self) -> RA_W<MACFFR_SPEC> {
        RA_W::new(self, 31)
    }

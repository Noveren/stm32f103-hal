...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn maca3h(&mut self) -> MACA3H_W<MACA3HR_SPEC> {
        MACA3H_W::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask byte control"]
    #[inline(always)]
    #[must_use]
    pub fn mbc(&mut self) -> MBC_W<MACA3HR_SPEC> {
        MBC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source address"]
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SA_W<MACA3HR_SPEC> {
        SA_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address enable"]
    #[inline(always)]
    #[must_use]
    pub fn ae(&mut self) -> AE_W<MACA3HR_SPEC> {
        AE_W::new(self, 31)
    }

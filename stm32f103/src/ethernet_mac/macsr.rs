...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pmts(&mut self) -> PMTS_W<MACSR_SPEC> {
        PMTS_W::new(self, 3)
    }
    #[doc = "Bit 4 - MMC status"]
    #[inline(always)]
    #[must_use]
    pub fn mmcs(&mut self) -> MMCS_W<MACSR_SPEC> {
        MMCS_W::new(self, 4)
    }
    #[doc = "Bit 5 - MMC receive status"]
    #[inline(always)]
    #[must_use]
    pub fn mmcrs(&mut self) -> MMCRS_W<MACSR_SPEC> {
        MMCRS_W::new(self, 5)
    }
    #[doc = "Bit 6 - MMC transmit status"]
    #[inline(always)]
    #[must_use]
    pub fn mmcts(&mut self) -> MMCTS_W<MACSR_SPEC> {
        MMCTS_W::new(self, 6)
    }
    #[doc = "Bit 9 - Time stamp trigger status"]
    #[inline(always)]
    #[must_use]
    pub fn tsts(&mut self) -> TSTS_W<MACSR_SPEC> {
        TSTS_W::new(self, 9)
    }

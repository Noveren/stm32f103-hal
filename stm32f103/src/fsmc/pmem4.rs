...
pub type R = crate::R<PMEM4_SPEC>;
#[doc = "Register `PMEM4` writer"]
pub type W = crate::W<PMEM4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn memsetx(&mut self) -> MEMSETX_W<PMEM4_SPEC> {
        MEMSETX_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - MEMWAITx"]
    #[inline(always)]
    #[must_use]
    pub fn memwaitx(&mut self) -> MEMWAITX_W<PMEM4_SPEC> {
        MEMWAITX_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - MEMHOLDx"]
    #[inline(always)]
    #[must_use]
    pub fn memholdx(&mut self) -> MEMHOLDX_W<PMEM4_SPEC> {
        MEMHOLDX_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - MEMHIZx"]
    #[inline(always)]
    #[must_use]
    pub fn memhizx(&mut self) -> MEMHIZX_W<PMEM4_SPEC> {

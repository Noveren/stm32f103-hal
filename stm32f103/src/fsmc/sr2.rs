...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irs(&mut self) -> IRS_W<SR2_SPEC> {
        IRS_W::new(self, 0)
    }
    #[doc = "Bit 1 - ILS"]
    #[inline(always)]
    #[must_use]
    pub fn ils(&mut self) -> ILS_W<SR2_SPEC> {
        ILS_W::new(self, 1)
    }
    #[doc = "Bit 2 - IFS"]
    #[inline(always)]
    #[must_use]
    pub fn ifs(&mut self) -> IFS_W<SR2_SPEC> {
        IFS_W::new(self, 2)
    }
    #[doc = "Bit 3 - IREN"]
    #[inline(always)]
    #[must_use]
    pub fn iren(&mut self) -> IREN_W<SR2_SPEC> {
        IREN_W::new(self, 3)
    }
    #[doc = "Bit 4 - ILEN"]
    #[inline(always)]
    #[must_use]
    pub fn ilen(&mut self) -> ILEN_W<SR2_SPEC> {
        ILEN_W::new(self, 4)
    }
    #[doc = "Bit 5 - IFEN"]
    #[inline(always)]
    #[must_use]
    pub fn ifen(&mut self) -> IFEN_W<SR2_SPEC> {
        IFEN_W::new(self, 5)
    }

...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tse(&mut self) -> TSE_W<PTPTSCR_SPEC> {
        TSE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Time stamp fine or coarse update"]
    #[inline(always)]
    #[must_use]
    pub fn tsfcu(&mut self) -> TSFCU_W<PTPTSCR_SPEC> {
        TSFCU_W::new(self, 1)
    }
    #[doc = "Bit 2 - Time stamp system time initialize"]
    #[inline(always)]
    #[must_use]
    pub fn tssti(&mut self) -> TSSTI_W<PTPTSCR_SPEC> {
        TSSTI_W::new(self, 2)
    }
    #[doc = "Bit 3 - Time stamp system time update"]
    #[inline(always)]
    #[must_use]
    pub fn tsstu(&mut self) -> TSSTU_W<PTPTSCR_SPEC> {
        TSSTU_W::new(self, 3)
    }
    #[doc = "Bit 4 - Time stamp interrupt trigger enable"]
    #[inline(always)]
    #[must_use]
    pub fn tsite(&mut self) -> TSITE_W<PTPTSCR_SPEC> {
        TSITE_W::new(self, 4)
    }
    #[doc = "Bit 5 - Time stamp addend register update"]
    #[inline(always)]
    #[must_use]
    pub fn tsaru(&mut self) -> TSARU_W<PTPTSCR_SPEC> {
        TSARU_W::new(self, 5)
    }

...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TS_W<DMASR_SPEC> {
        TS_W::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit process stopped status"]
    #[inline(always)]
    #[must_use]
    pub fn tpss(&mut self) -> TPSS_W<DMASR_SPEC> {
        TPSS_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable status"]
    #[inline(always)]
    #[must_use]
    pub fn tbus(&mut self) -> TBUS_W<DMASR_SPEC> {
        TBUS_W::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit jabber timeout status"]
    #[inline(always)]
    #[must_use]
    pub fn tjts(&mut self) -> TJTS_W<DMASR_SPEC> {
        TJTS_W::new(self, 3)
    }
    #[doc = "Bit 4 - Receive overflow status"]
    #[inline(always)]
    #[must_use]
    pub fn ros(&mut self) -> ROS_W<DMASR_SPEC> {
        ROS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit underflow status"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rs(&mut self) -> RS_W<DMASR_SPEC> {
        RS_W::new(self, 6)
    }
    #[doc = "Bit 7 - Receive buffer unavailable status"]
    #[inline(always)]
    #[must_use]
    pub fn rbus(&mut self) -> RBUS_W<DMASR_SPEC> {
        RBUS_W::new(self, 7)
    }
    #[doc = "Bit 8 - Receive process stopped status"]
    #[inline(always)]
    #[must_use]
    pub fn rpss(&mut self) -> RPSS_W<DMASR_SPEC> {
        RPSS_W::new(self, 8)
    }
    #[doc = "Bit 9 - Receive watchdog timeout status"]
    #[inline(always)]
    #[must_use]
    pub fn pwts(&mut self) -> PWTS_W<DMASR_SPEC> {
        PWTS_W::new(self, 9)
    }
    #[doc = "Bit 10 - Early transmit status"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn fbes(&mut self) -> FBES_W<DMASR_SPEC> {
        FBES_W::new(self, 13)
    }
    #[doc = "Bit 14 - Early receive status"]
    #[inline(always)]

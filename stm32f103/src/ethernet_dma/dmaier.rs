...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tpsie(&mut self) -> TPSIE_W<DMAIER_SPEC> {
        TPSIE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tbuie(&mut self) -> TBUIE_W<DMAIER_SPEC> {
        TBUIE_W::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit jabber timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tjtie(&mut self) -> TJTIE_W<DMAIER_SPEC> {
        TJTIE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Overflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn roie(&mut self) -> ROIE_W<DMAIER_SPEC> {
        ROIE_W::new(self, 4)
    }
    #[doc = "Bit 5 - Underflow interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn tuie(&mut self) -> TUIE_W<DMAIER_SPEC> {
        TUIE_W::new(self, 5)
    }
    #[doc = "Bit 6 - Receive interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rbuie(&mut self) -> RBUIE_W<DMAIER_SPEC> {
        RBUIE_W::new(self, 7)
    }
    #[doc = "Bit 8 - Receive process stopped interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rpsie(&mut self) -> RPSIE_W<DMAIER_SPEC> {
        RPSIE_W::new(self, 8)
    }
    #[doc = "Bit 9 - receive watchdog timeout interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rwtie(&mut self) -> RWTIE_W<DMAIER_SPEC> {
        RWTIE_W::new(self, 9)
    }
    #[doc = "Bit 10 - Early transmit interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn etie(&mut self) -> ETIE_W<DMAIER_SPEC> {
        ETIE_W::new(self, 10)
    }
    #[doc = "Bit 13 - Fatal bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn fbeie(&mut self) -> FBEIE_W<DMAIER_SPEC> {
        FBEIE_W::new(self, 13)
    }
    #[doc = "Bit 14 - Early receive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn erie(&mut self) -> ERIE_W<DMAIER_SPEC> {
        ERIE_W::new(self, 14)
    }
    #[doc = "Bit 15 - Abnormal interrupt summary enable"]
    #[inline(always)]
    #[must_use]
    pub fn aise(&mut self) -> AISE_W<DMAIER_SPEC> {
        AISE_W::new(self, 15)
    }
    #[doc = "Bit 16 - Normal interrupt summary enable"]
    #[inline(always)]
    #[must_use]
    pub fn nise(&mut self) -> NISE_W<DMAIER_SPEC> {
        NISE_W::new(self, 16)
    }
